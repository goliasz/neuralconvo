...
function CornellMovieDialogs:load()
  ...
  for line in parsedLines(self.dir .. "/movie_lines_doctor.txt", MOVIE_LINES_FIELDS) do
  ...
  for conv in parsedLines(self.dir .. "/movie_conversations_doctor.txt", MOVIE_CONVERSATIONS_FIELDS) do
    local conversation = {}
